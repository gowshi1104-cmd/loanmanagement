...
public class DashboardServiceImpl implements DashboardService {
    ...
    public DashboardResponse getDashboard() {
        ...
        List<Loan> recentLoans =
                loanRepository.findTop10ByOrderByLoanDateDesc();

        List<DashboardResponse.RecentLoanResponse>
                recentLoanResponses =
                recentLoans.stream()
    ...
    // =========================================================
    // MAP LOAN → DASHBOARD DTO
    // =========================================================

    private DashboardResponse.RecentLoanResponse mapRecentLoan(
            Loan loan) {
        ...
        return new DashboardResponse.RecentLoanResponse(
